...
is ( $hsc->mpileup_command, q(samtools-1.1.30 mpileup -d 500 -t INFO/DPR,DV -C50 -ugf t/data/15360_1#1_het_test_staph_aureus_subsample_2000.fa t/data/qc-sample/15360_1#1.bam | bgzip > t/data/qc-sample/15360_1#1_temp_vcf.vcf.gz), 'mpileup command');
