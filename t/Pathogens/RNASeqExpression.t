...
is($obj->does_reference_in_bam_match_annotation("t/data/rnaseq_expression.bam", "/path/to/something_which_doesnt_match.gff"), 1, 'annotation base name doesnt matche reference');
