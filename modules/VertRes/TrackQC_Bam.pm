...
=head2 new
        ...
        Example    : my $qc = VertRes::TrackQC_Bam->new( 'sample_dir'=>'dir', 'sample_size'=>1e6 );
...
my \$qc = VertRes::TrackQC_Bam->new(\%params);
