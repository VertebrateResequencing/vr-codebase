package VertRes::Pipelines::TrackQC;
...
=head2 new
        ...
        Example    : my $qc = VertRes::Pipelines::TrackDummy->new( 'sample_dir'=>'dir', 'sample_size'=>1e6 );
...
sub VertRes::Pipelines::TrackQC::new 
{
    my ($class, @args) = @_;
...
my \$qc = VertRes::Pipelines::TrackQC->new(\%params);
