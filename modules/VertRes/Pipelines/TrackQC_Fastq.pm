...
our $options = 
{
    ...
    'bsub_opts_map_sample'         => "-q normal -M1000000 -R 'select[type==X86_64] select[mem>1000] rusage[mem=1000] rusage[thouio=1]'",
    'bsub_opts_process_fastqs'     => "-q normal -M1000000 -R 'select[type==X86_64] select[mem>1000] rusage[mem=1000] rusage[thouio=1]'",
