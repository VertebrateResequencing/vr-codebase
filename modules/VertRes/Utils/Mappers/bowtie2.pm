...
VertRes::Utils::Mappers::bowtie2 - mapping utility functions

=head1 SYNOPSIS

use VertRes::Utils::Mappers::bowtie2;

my $mapping_util = VertRes::Utils::Mappers::bowtie2->new();
...
package VertRes::Utils::Mappers::bowtie2;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = VertRes::Utils::Mappers::bowtie2->new();
 Function: Create a new VertRes::Utils::Mappers::bowtie2 object.
 Returns : VertRes::Utils::Mappers::bowtie2 object
 Args    : n/a
...
sub _bsub_opts {
    ...
    if ($action eq 'map') {
        $bsub_opts{bsub_opts} = '-q long -M4000000 -R \'select[mem>4000] rusage[mem=4000]\'';
    }
    else {
...
=head2 wrapper
 ...
 Returns : VertRes::Wrapper::bowtie2 object (call do_mapping() on it)
 Args    : n/a
...
sub wrapper {
    ...
    return VertRes::Wrapper::bowtie2->new(verbose => $self->verbose, exe => $exe);
}
