...
VertRes::Utils::Assemblers::canu - assembly utility functions

=head1 SYNOPSIS

use VertRes::Utils::Assemblers::canu;

my $assembly_util = VertRes::Utils::Assemblers::canu->new();

# use any of the utility functions described here, eg.
my $assember = $assembler_class->new(
  assembler_exec => '/path/to/canu',
  optimiser_exec => '/path/to/canu',
);
...
canu-specific assembly functions
...
package VertRes::Utils::Assemblers::canu;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = VertRes::Utils::Assemblers::canu->new();
 Function: Create a new VertRes::Utils::Assemblers::canu object.
 Returns : VertRes::Utils::Assemblers::canu object
 Args    : n/a
...
{
  my ($self) = @_;
  return File::Spec->catfile($self->{output_directory}, 'canu_1_6_assembly');
}
...
=head2 get_parameters
 ...
 Function: get parameters. Extend later to read the canu.log file
