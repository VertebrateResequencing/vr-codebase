...
VertRes::Utils::Assemblers::pacbio - assembly utility functions

=head1 SYNOPSIS

use VertRes::Utils::Assemblers::pacbio;

my $assembly_util = VertRes::Utils::Assemblers::pacbio->new();

# use any of the utility functions described here, eg.
my $assember = $assembler_class->new(
  assembler_exec => '/path/to/pacbio',
  optimiser_exec => '/path/to/pacbio',
);
...
pacbio-specific assembly functions
...
package VertRes::Utils::Assemblers::pacbio;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = VertRes::Utils::Assemblers::pacbio->new();
 Function: Create a new VertRes::Utils::Assemblers::pacbio object.
 Returns : VertRes::Utils::Assemblers::pacbio object
 Args    : n/a
...
{
  my ($self) = @_;
  return File::Spec->catfile($self->{output_directory}, 'pacbio_assembly');
}
...
=head2 get_parameters
 ...
 Function: get parameters. Extend later to read the pacbio.log file
