...
use constant SCHEMA_VERSION => '21';
...
CREATE TABLE `seq_request` (
  ...
  `ssid` mediumint(8) unsigned DEFAULT NULL,
  `seq_type` enum('Illumina-A HiSeq Paired end sequencing','Single ended sequencing','Paired end sequencing','HiSeq Paired end sequencing','MiSeq sequencing','Single ended hi seq sequencing') DEFAULT 'Single ended sequencing',
