...
update_vrtrack.pl --database vrtrack_uk10k_neuro --projects $CONF/uk10k_neuro_studies --create_individuals > "$ROOT/log/vrtrack_update_uk10k_neuro.log" 2> "$ROOT/log/vrtrack_update_uk10k_neuro.err"
