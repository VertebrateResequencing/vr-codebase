...
update_vrtrack.pl --database vrtrack_uk10k_cohort --projects $CONF/uk10k_cohort_studies --create_individuals --no_fastq > "$ROOT/log/vrtrack_update_uk10k_cohort.log" 2> "$ROOT/log/vrtrack_update_uk10k_cohort.err"
