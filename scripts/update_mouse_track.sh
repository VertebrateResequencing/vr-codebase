...
HUMAN_EXOME_PROJ_ROOT="$ROOT/projects/vrtrack_human_exome"
...
#EXOME update the individuals and samples files
/software/vertres/scripts/generateIndividualSamplesMap.pl -s $HUMAN_EXOME_PROJ_ROOT/meta-data/studies.fofn -m $HUMAN_EXOME_PROJ_ROOT/meta-data/individuals2Samples.tab -spe Homo_sapien -t 9606 -nm $HUMAN_EXOME_PROJ_ROOT/meta-data/new_individuals2Samples.tab -ns $HUMAN_EXOME_PROJ_ROOT/meta-data/samples.tab 2> "$ROOT/log/sample_map_vrtrack_human_exome.out"
mv $HUMAN_EXOME_PROJ_ROOT/meta-data/individuals2Samples.tab $HUMAN_EXOME_PROJ_ROOT/meta-data/individuals2Samples.tab_old
mv $HUMAN_EXOME_PROJ_ROOT/meta-data/new_individuals2Samples.tab $HUMAN_EXOME_PROJ_ROOT/meta-data/individuals2Samples.tab
...
/software/vertres/scripts/load_vrtrack_individuals.pl --indiv $HUMAN_EXOME_PROJ_ROOT/meta-data/samples.tab -db vrtrack_human_exome 2> "$ROOT/log/load_ind_vrtrack_human_exome.out"
...
/software/vertres/scripts/update_vrtrack.pl --projects $HUMAN_EXOME_PROJ_ROOT/meta-data/studies.fofn --database vrtrack_human_exome --sample_map $HUMAN_EXOME_PROJ_ROOT/meta-data/individuals2Samples.tab 2> "$ROOT/log/update_vrtrack_human_exome.out"
