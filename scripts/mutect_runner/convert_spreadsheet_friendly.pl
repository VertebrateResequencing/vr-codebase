...
my @text = ( 'ID','ID_orig','Cosmic','Cosmic_annot','SITES','TUM_TYPE','REF','ALT','MUTECT_FILTER','DP4T','TumourAltBases (Ref,Alt)','NormalAltBases (Ref,Alt)','ENS_GENEID','GENE_SYMBOL','CONSEQUENCE','AA_CHANGE','PICK','TRANSCRIPTS','TRANS_BIOTYPE','ENS_ID','Cell_line','Sample');
